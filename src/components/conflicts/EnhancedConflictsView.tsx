    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          {selectedIds.size > 0 && (
            <Button onClick={batchResolve} disabled={batchResolving}>
              {batchResolving ? (
                  ...
                  <div className="mb-4">
                    ...
                    {autoResolvableConflicts.map((conflict) => (
                      <motion.div
                        ...
                        className={cn(
                          "p-4 rounded-lg border transition-all cursor-pointer mb-2",
                          selectedIds.has(conflict.id) ? "bg-primary/5 border-primary" : "bg-card hover:bg-muted/50",
                  ...
                  <div>
                    ...
                    {manualActionConflicts.map((conflict) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className={cn(
                          "p-4 rounded-lg border transition-all cursor-pointer mb-2 opacity-90",
